...
export async function runInvoiceCleanup(db, env = {}) {
  ...
  try {
    ...
    // Use quoted name for order table to avoid reserved word issues
  ...
  // Find invoices with pdfUrl older than cutoff (best-effort when filesystem not available)
  ...
  // Find orders with receiptUrl older than cutoff
