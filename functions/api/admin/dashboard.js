...
export async function onRequest(context) {
  ...
  try {
    ...
    const sumUsd = (Array.isArray(inventorySumRes?.results) ? inventorySumRes.results[0]?.sumUsd : (Array.isArray(inventorySumRes) ? inventorySumRes[0]?.sumUsd : 0)) || 0;
