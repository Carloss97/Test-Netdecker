...
import * as movementModule from './functions/api/erp/stock/movement.js';
import * as snapshotModule from './functions/api/erp/stock/snapshot.js';
import * as transferModule from './functions/api/erp/stock/transfer.js';
import * as reservationsIndexModule from './functions/api/erp/reservations/index.js';
import * as reservationsCommitModule from './functions/api/erp/reservations/[id]/commit.js';
import * as reservationsReleaseModule from './functions/api/erp/reservations/[id]/release.js';
...
test('reservations create, commit and release flows', async () => {
  ...
  const resIndex = reservationsIndexModule;
  const resCommit = reservationsCommitModule;
  const resRelease = reservationsReleaseModule;
